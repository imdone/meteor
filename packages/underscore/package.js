...
Package.onUse(function (api) {
  ...
  //
  // XXX Now the *.js handler is intrinsic rather than coming from the id:699 gh:700
  ...
  // NOTE: we patch _.each and various other functions that polymorphically take id:324 gh:325
